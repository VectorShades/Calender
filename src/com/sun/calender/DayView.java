...
getReminderDataFromDB();
        ...
        topText.setText("Today's Reminders");

        AllView.setOnClickListener(new ImageButton.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(DayView.this, ReminderView.class);
        ...
        weekView.setOnClickListener(new ImageButton.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(DayView.this, WeekView.class);
				startActivity(intent);
				finish();
			}
		});
		...
		monthView.setOnClickListener(new ImageButton.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(DayView.this, MonthView.class);
				startActivity(intent);
			finish();
			}
		});
		...
		AddReminder.setOnClickListener(new ImageView.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(DayView.this, AddReminder.class);
				startActivity(intent);
				finish();
			}
		});
	...
	private void getReminderDataFromDB()
    {
     ...
     List<ReminderDAO> reminders = datasource.getTodayReminder();
		...
		public boolean onOptionsItemSelected(MenuItem item)
		    {
		        ...
		        case R.id.menu_setting:
		        	Intent intent1= new Intent(DayView.this, Setting.class);
					startActivity(intent1);
		        	return true;
		 
		        case R.id.menu_exit:
		            Toast.makeText(DayView.this, "Exit is Selected", Toast.LENGTH_SHORT).show();
		            return true;
