...
public class WeekView extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        topText.setText("Week's Reminders");

        AllView.setOnClickListener(new ImageButton.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(WeekView.this, ReminderView.class);
        ...
        dayView.setOnClickListener(new ImageButton.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(WeekView.this, DayView.class);
				startActivity(intent);
				finish();
		...
		monthView.setOnClickListener(new ImageButton.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(WeekView.this, MonthView.class);
				startActivity(intent);
			finish();
			}
		});
		...
		AddReminder.setOnClickListener(new ImageView.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent= new Intent(WeekView.this, AddReminder.class);
				startActivity(intent);
				finish();
			}
		});
	...
	private void getReminderDataFromDB()
    {
     ...
     List<ReminderDAO> reminders = datasource.getWeeksReminder();
		...
		public boolean onOptionsItemSelected(MenuItem item)
		    {
		        ...
		        case R.id.menu_setting:
		        	Intent intent1= new Intent(WeekView.this, Setting.class);
					startActivity(intent1);
		        	return true;
		 
		        case R.id.menu_exit:
		            Toast.makeText(WeekView.this, "Exit is Selected", Toast.LENGTH_SHORT).show();
		            return true;
